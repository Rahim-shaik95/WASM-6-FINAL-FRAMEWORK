...
public class CreateOrgNameAndIndustryWithDDT {
	...
	public static void main(String[] args) throws Exception {
		...
		String Industry1 = cl.getStringCellValue();
		...
		driver.findElement(By.xpath("(//select[@name='industry'])/option[18]")).click();
		driver.findElement(By.xpath("//select[@name='accounttype']/option[2]")).click();
